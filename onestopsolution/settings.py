"""
Django settings for onestopsolution project.
...
SECRET_KEY = 'django-insecure-xp1t7+b=a(gx413qn%2#n^wk(88er)j1$pf8@+&!*$4abs#y#c'
...
ROOT_URLCONF = 'onestopsolution.urls'
...
WSGI_APPLICATION = 'onestopsolution.wsgi.application'
