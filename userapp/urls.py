...
urlpatterns = [
    ...
    path('filteredjoblist/', FilterJobListView.as_view(), name="filterjobs"),
    ...
    path('settings/<int:pk>/', SettingView.as_view(), name="settings"),
    ...
    path('updateworkerprofile/<int:pk>/', WorkerProfileUpdateView.as_view(), name="updateworkerprofile"),
